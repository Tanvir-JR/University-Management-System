...
$full_name = $User_Name = $User_Rule = $email =$User_Password = "";
$full_nameEr = $User_NameEr = $User_RuleEr = $emailEr= $User_PasswordEr = '';
$valid = false;
$successMesg = $errorMesg = "";
    ...
    if (!$valid) {
       ...
       $result = register($full_name, $username, $password,$email, $User_Rule);
